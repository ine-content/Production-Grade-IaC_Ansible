...
This TODO's grader also temporarily edits `group_vars/staging.yml` while re-verifying TODO 03, and restores it afterward — you don't need to do anything about that yourself either.
...
```text
site.yml   (TODO 05 - and every later TODO in this course)
```
